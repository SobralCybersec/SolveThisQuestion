...
export async function askProxy(prompt, pageState, screenshot, webSearch, imageUpload) {
...
export async function chat(command) {
...
export async function resetEmbeddedProxy() {
...
export async function embeddedCloseLogin() {
